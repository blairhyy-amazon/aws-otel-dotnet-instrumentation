...
class AWSSdkTest(ContractTestBase):
    ...
    def test_dynamodb_describe_table(self):
        self.do_test_requests(
            ...
            remote_resource_type="AWS::DynamoDB::Table",
            remote_resource_identifier="test-table-cross-account",
            remote_resource_account_id="000000000000",
            remote_resource_region="us-east-1",
            cloudformation_primary_identifier="test-table-cross-account",
            request_response_specific_attributes={
                "aws.table_name": ["test-table-cross-account"],
            },
            response_specific_attributes={
                _AWS_DYNAMODB_TABLE_ARN: r"arn:aws:dynamodb:us-east-1:000000000000:table/test-table-cross-account",
            },
    ...
    def test_kinesis_describe_stream(self):
        self.do_test_requests(
            ...
            remote_resource_type="AWS::Kinesis::Stream",
            remote_resource_identifier="test-stream-cross-account",
            cloudformation_primary_identifier="test-stream-cross-account",
            remote_resource_account_id="000000000000",
            remote_resource_region="us-east-1",
            request_response_specific_attributes={
                _AWS_KINESIS_STREAM_NAME: "test-stream-cross-account",
                _AWS_KINESIS_STREAM_ARN: r"arn:aws:kinesis:us-east-1:000000000000:stream/test-stream-cross-account",
            },
